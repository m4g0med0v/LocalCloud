...
class StorageObjectManager:
    ...
    async def put_object(
        ...
        *,
        ...
        Raises:
            StorageUploadError: Если данные или размер объекта некорректны,
                либо загрузка не удалась.
    ...
    async def object_exists(
        ...
        *,
        ...
        Raises:
            StorageObjectError: Если проверка завершилась ошибкой, отличной
                от отсутствия объекта.
        """
    ...
    async def delete_object(
        ...
        *,
        ...
        Returns:
            ``True``, если объект удалён. ``False``, если объект отсутствует
    ...
    async def copy_object(
        ...
        *,
        ...
        Если ``metadata`` не переданы, MinIO/S3 сохраняет metadata исходника.
    ...
    async def compose_object(
        ...
        *,
        ...
        Raises:
            ...
            StorageObjectNotFoundError: Если один из исходных объектов
                не найден.
        """
    ...
    def _prepare_data_stream(data: BinaryIO | bytes | bytearray) -> BinaryIO:
        ...
        Args:
            data: Данные объекта в виде ``bytes``, ``bytearray`` или
                file-like объекта.
