...
class StorageBucketManager:
    ...
    async def create_bucket(
        ...
        *,
        ...
        Если ``ignore_existing`` равен ``True`` и bucket уже существует,
        метод возвращает информацию о существующем bucket.
    ...
    async def ensure_bucket_exists(
        ...
        *,
        ...
        Если bucket уже существует, возвращает информацию о нём.
        Если bucket отсутствует, создаёт его.
    ...
    async def remove_bucket_if_empty(
        ...
        *,
        ...
        Raises:
            StorageBucketError: Если bucket не пустой или операция удаления
                не удалась.
            StorageBucketNotFoundError: Если bucket отсутствует.
            InvalidStorageBucketNameError: Если имя bucket некорректно.
        """
