"""Сервис оркестрации фоновых задач.

Модуль содержит бизнес-логику создания, планирования, просмотра, отмены,
повторного запуска и обновления фоновых задач. Также поддерживает отметку задач
как завершенных или ошибочных, получение результата задачи, очистку старых
завершенных задач и обработку зависших running-задач.

Основные операции модуля:
    * Создание фоновых задач поддерживаемых типов.
    * Планирование задач архивации папки, очистки корзины, очистки upload-сессий
      и пересчета квоты пользователя.
    * Получение одной задачи и списка задач с учетом прав доступа.
    * Отмена и повторный запуск задач.
    * Обновление прогресса выполнения задачи.
    * Отметка задачи как завершенной или завершенной с ошибкой.
    * Получение результата задачи.
    * Пометка зависших running-задач как failed.
    * Удаление завершенных задач по фильтрам.
    * Получение статистики задач по статусам.
    * Запись событий фоновых задач в аудит.
"""
