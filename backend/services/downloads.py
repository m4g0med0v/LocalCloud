"""
Сервис создания ссылок для скачивания файлов и архивов папок.

Модуль содержит бизнес-логику скачивания объектов файловой системы через
предварительно подписанные URL. Он поддерживает скачивание текущей версии файла,
скачивание выбранной версии файла, постановку фоновой задачи на создание ZIP-архива
папки и получение ссылки на готовый архив.

Основные операции модуля:
    * Проверка прав пользователя на скачивание файлов и папок.
    * Проверка доступности файловых объектов и архивных задач.
    * Создание предварительно подписанных URL через сервис хранилища.
    * Формирование response-заголовков для скачивания или inline-открытия.
    * Создание снимков ORM-моделей для безопасного использования вне Unit of Work.
    * Запись успешных операций скачивания в аудит.
"""
