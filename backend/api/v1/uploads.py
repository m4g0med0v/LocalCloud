...
для загрузки частей файла, подтверждения загруженных частей, завершения
и отмены multipart-загрузки.

Все операции выполняются от имени текущего активного пользователя.
