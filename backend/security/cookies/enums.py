...
class AuthCookieName(StrEnum):
    """Имена cookie, используемых для хранения authentication tokens.
...
class CookieErrorCode(StrEnum):
    ...
    Используется для унифицированного описания ошибок валидации,
    создания, чтения и удаления authentication cookie.
