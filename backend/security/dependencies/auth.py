...
async def get_current_access_payload(
    ...
    Raises:
        SecurityDependencyError: Если access token отсутствует, истёк,
...
async def get_optional_access_payload(
    ...
    Returns:
        Декодированный payload access token или None, если cookie отсутствует.
...
async def get_current_refresh_payload(
    ...
    Raises:
        SecurityDependencyError: Если refresh token отсутствует, истёк,
            имеет неверный тип, содержит некорректные claims или недействителен.
    """
...
async def get_optional_refresh_payload(
    ...
    Returns:
        Декодированный payload refresh token или None, если cookie отсутствует.
