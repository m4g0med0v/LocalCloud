...
class RegistrationRequest(Base, UUIDPrimaryKeyMixin, CreatedAtMixin):
    ...
    __tablename__ = "registration_requests"  # pyright: ignore[reportAssignmentType]
