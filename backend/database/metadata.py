...
def get_metadata() -> MetaData:
    ...
    Используется в:
        ...
        - инфраструктурных функциях создания/удаления схемы.
...
def get_table_names(
    *,
    ...
    """Возвращает список имён таблиц, зарегистрированных в metadata.
...
def get_tables(
    *,
    ...
    """Возвращает список SQLAlchemy Table-объектов.
...
def has_table(table_name: str) -> bool:
    ...
    Returns:
        True, если таблица зарегистрирована в metadata.
    """
...
def require_tables(table_names: Iterable[str]) -> None:
    """Проверяет, что все указанные таблицы зарегистрированы в metadata.
