...
class FileRepository(BaseRepository[File]):
    ...
    async def create_file(
        ...
        *,
        ...
        Метод не создаёт `FileSystemNode`. Узел должен быть создан заранее через
        `FileSystemNodeRepository` и иметь тип `FILE`.
        ...
        Args:
            ...
            check_duplicate_node: Проверять ли наличие уже существующей записи файла для узла.
        ...
        Raises:
            ...
            InvalidQueryError: Если узел не является файлом или входные значения некорректны.
