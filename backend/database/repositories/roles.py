...
class RolesRepository(BaseRepository[Role]):
    ...
    async def get_role_by_id(
        ...
        """Возвращает роль по идентификатору или ``None``.
    ...
    async def get_role_by_name(
        ...
        *,
        ...
        """Возвращает роль по системному имени или ``None``.

        Args:
            name: Системное имя роли.
            case_sensitive: Если True, поиск выполняется с учётом регистра.
    ...
    async def get_role_by_code(
        ...
        *,
        ...
        """Возвращает роль по стабильному коду или ``None``.
    ...
    async def get_admin_role(self) -> Role | None:
        """Возвращает системную роль администратора или ``None``.
    ...
    async def get_user_role_model(self) -> Role | None:
        """Возвращает системную роль обычного пользователя или ``None``.
    ...
    async def role_exists(
        ...
        *,
        ...
        """Проверяет, существует ли роль по имени или коду.
        ...
        Args:
            ...
            exclude_role_id: Идентификатор роли, которую нужно исключить из
                проверки.
            case_sensitive: Если True, проверка выполняется с учётом регистра.
    ...
    async def update_role(
        ...
        *,
        ...
        Для системных ролей запрещено менять ``name``, ``code`` и
        ``is_system``.
    ...
    async def list_roles(
        ...
        *,
        ...
        Args:
            ...
            order_by_name: Если True, сортирует по имени роли, иначе — по дате
                создания.
    ...
    async def assign_admin_role(
        ...
        *,
        ...
        Raises:
            EntityNotFoundError: Если пользователь или роль администратора не
                найдены.
    ...
    async def remove_role(
        ...
        *,
        ...
        Returns:
            True, если назначение было удалено. False, если назначение не
            найдено и ``required`` равен False.
    ...
    async def user_has_role(
        ...
        *,
        ...
        Returns:
            True, если у пользователя есть указанная роль.
    ...
    async def get_user_role(
        ...
        *,
        ...
        """Возвращает назначение роли пользователю или ``None``.
    ...
    async def exists_user_role(
        ...
        *,
        ...
        Returns:
            True, если назначение роли существует.
        """
    ...
    async def get_user_roles(
        ...
        *,
        ...
        Args:
            ...
            order_by_name: Если True, сортирует роли по имени. Иначе сортирует
                по дате назначения.
    ...
    async def get_user_role_codes(
        ...
        *,
        ...
        Args:
            user_id: Идентификатор пользователя.
            only_active_roles: Возвращать только активные роли.
            order_by_code: Если True, сортирует роли по коду. Иначе сортирует
                по дате назначения.
    ...
    async def replace_user_roles(
        ...
        *,
        ...
        Raises:
            EntityNotFoundError: Если пользователь или одна из ролей не
                найдены.
        """
