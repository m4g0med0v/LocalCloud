...
class FileSystemNodeRepository(BaseRepository[FileSystemNode]):
    ...
    async def create_node(
        ...
        *,
        ...
        Метод создаёт только запись в `file_system_nodes`.
        Связанные записи в таблицах `files` или `folders` должны создаваться
        ...
        Raises:
            InvalidQueryError: Если имя, путь, глубина или родительский узел некорректны.
            EntityNotFoundError: Если владелец или родительский узел не найден.
            DuplicateEntityError: Если в папке уже существует активный узел с таким именем.
        """
    ...
    async def move_node(
        ...
        *,
        ...
        Raises:
            EntityNotFoundError: Если узел или новая родительская папка не найдены.
            InvalidQueryError: Если перемещение некорректно.
            DuplicateEntityError: Если в целевой папке уже есть активный узел с таким именем.
        """
    ...
    def _validate_node_name(
        ...
        Имя не должно быть пустым, содержать символ `/`, быть равно `.` или `..`,
        а также превышать 255 символов.
