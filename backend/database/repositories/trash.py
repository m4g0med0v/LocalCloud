...
class TrashItemRepository(BaseRepository[TrashItem]):
    ...
    async def get_by_node_id(
        ...
        *,
        ...
        Args:
            ...
            include_purged: Включать ли элементы, уже помеченные как окончательно удалённые.
    ...
    async def create_trash_item(
        ...
        *,
        ...
        Если `soft_delete_node=True`, связанный `FileSystemNode` также помечается
        удалённым через `FileSystemNodeRepository`. При рекурсивном удалении
        удалённым помечается всё поддерево узла.
    ...
    async def get_user_trash(
        ...
        *,
        ...
        Args:
            ...
            include_non_restorable: Включать ли элементы, недоступные для восстановления.
    ...
    async def get_expired_items(
        ...
        *,
        ...
        В выборку попадают элементы с установленным `expires_at`, у которых срок
        хранения меньше или равен указанному моменту, и которые ещё не были очищены.
    ...
    async def get_items_ready_for_purge(
        ...
        *,
        ...
        Метод является удобной обёрткой над `get_expired_items()` и предназначен
        для задач очистки корзины.
    ...
    async def mark_restored(
        ...
        *,
        ...
        Если `restore_node=True`, связанный `FileSystemNode` также восстанавливается
        через `FileSystemNodeRepository`.
    ...
    async def mark_purged(
        ...
        *,
        ...
        Если `purge_node=True`, связанный `FileSystemNode` физически удаляется
        через `FileSystemNodeRepository.mark_purged()`.

        Args:
            trash_item_id: Идентификатор элемента корзины.
            node_id: Идентификатор связанного узла файловой системы.
            purged_at: Дата окончательной очистки. Если не передана, используется текущее UTC-время.
    ...
    async def enable_restore(
        ...
        *,
        ...
        Нельзя включить восстановление для элемента, который уже был окончательно
        удалён и имеет установленный `purged_at`.
    ...
    async def delete_trash_item(
        ...
        *,
        ...
        Метод удаляет только запись корзины, но не удаляет связанный `FileSystemNode`.
        ...
        Raises:
            InvalidQueryError: Если переданы некорректные идентификаторы.
            EntityNotFoundError: Если элемент корзины не найден и `required=True`.
        """
    ...
    async def delete_purged_items(
        ...
        *,
        ...
        """Физически удаляет записи корзины, уже помеченные как окончательно удалённые.

        Args:
            owner_id: Фильтр по владельцу элементов корзины.
            older_than: Удалять только элементы, очищенные не позже указанного момента.
            flush: Выполнить ли `flush` после удаления.
    ...
    async def count_user_trash_items(
        ...
        *,
        ...
        Args:
            ...
            only_restorable: Учитывать только элементы, доступные для восстановления.
    ...
    async def count_active_user_trash_items(
        ...
        *,
        ...
        При `exclude_expired=True` элементы с истёкшим сроком хранения не учитываются.
    ...
    async def can_restore(
        ...
        *,
        ...
        Метод возвращает `False`, если элемент не найден, недоступен для восстановления,
        уже очищен окончательно или, при `check_expiration=True`, срок хранения истёк.
    ...
    async def is_expired(
        ...
        *,
        ...
        Если элемент не найден или `expires_at` не установлен, возвращает `False`.
    ...
    async def _get_required_by_trash_item_id_or_node_id(
        ...
        *,
        ...
        """Возвращает обязательный элемент корзины по `trash_item_id` или `node_id`.
    ...
    def _validate_expiration(
        ...
        *,
        ...
        Raises:
            InvalidQueryError: Если срок хранения меньше либо равен времени удаления.
        """
    ...
    async def create(
        ...
        *,
        ...
        Raises:
            DuplicateEntityError: Если для указанного узла уже существует элемент корзины.
